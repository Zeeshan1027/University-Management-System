...
<html class="no-js" lang="">
    <head>
        ...
        <meta name="description" content="VIT University">
		<meta name="author" content="Shaifali Choudhary">
			...
			<div id="sticker">
				...
				<div class="menu ">
					...
					<ul>
						...
						<li><a href="st_change_pass.php"><i class="fa fa-cog" aria-hidden="true"></i> Change Password</a></li>
						<li><a href="courses.php"><i class="fa fa-cog" aria-hidden="true"></i> Courses</a></li>
						<li><a href="view_single_result.php?vr=<?php echo $sid?>&vn=<?php echo $sname?>"><i class="fa fa-cog" aria-hidden="true"></i> Result</a></li>
						...
						<?php if($user->get_faculty_session()){ ?>
								...
								<li><a href="result_st.php"><i class="fa fa-cog" aria-hidden="true"></i> Result</a></li>
