...
<div class="all_student fix">
	...
	//select semester
		...
		?>
			<p style="float:left; text-align:right;margin:20px 0;width:49%"><a href="result_st_update.php?ar=<?php echo $stid?>&seme=<?php echo $semester?>&vn=<?php echo $name?>"><button class="editbtn">Edit Result</button></a></p>
		<?php 
				}
		?>
		
			<p style="float:right;text-align:left;margin:20px 0;width:49%"><a href="result_st.php"><button class="editbtn">Back to list</button></a></p>
