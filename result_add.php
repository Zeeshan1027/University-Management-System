...
<div class="all_student fix">
	...
	<div style="width:40%;margin:50px auto">
				...
				<table>
					<tr>
						...
						<select name="subject" id="">
							...
							<option value="Human Computer and Interaciton">Human Computer and Interaction</option>
		...
		<div class="back fix">
				<p style="text-align:center"><a href="result_st.php"><button class="editbtn">Back to list</button></a></p>
			</div>
</div>
